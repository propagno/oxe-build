...
interface ContextAPI {
    ...
    extractSemanticFragment: (text: string, options?: {
        intent?: string;
        maxChars?: number;
...
interface OxeSdk {
    ...
    health: {
        loadOxeConfigMerged: (targetProject: string) => {
            config: Record<string, unknown>;
            path: string | null;
            parseError: string | null;
            sources: {
        ...
        validateConfigShape: (cfg: Record<string, unknown>) => {
            unknownKeys: string[];
            typeErrors: string[];
        };
        ...
        detectWorkspaceMode: (target: string) => {
            workspaceMode: WorkspaceMode;
            packageName: string | null;
            canonicalTreePresent: boolean;
            commandsTreePresent: boolean;
        };
        ...
        suggestNextStep: (target: string, cfg?: {
            discuss_before_plan?: boolean;
        }) => OxeNextSuggestion;
        ...
        copilotWorkspacePaths: (target: string) => {
            root: string;
            promptsDir: string;
            instructions: string;
            manifest: string;
    ...
    workflows: {
        ...
        validateWorkflowShapes: (workflowsDir: string, options?: {
            maxBytesSoft?: number;
        }) => WorkflowShapeResult;
    ...
    install: {
        resolveOptionsFromConfig: (projectRoot: string, optsIn: Record<string, unknown>) => {
    ...
    security: {
        ...
        scanFileForSecrets: (filePath: string, options?: {
            contentPatterns?: RegExp[];
        }) => SecretScanResult;
        scanDirForSecretFiles: (dir: string, options?: {
            secretPatterns?: RegExp[];
            maxDepth?: number;
        }) => string[];
        validatePlanPaths: (filePaths: string[], projectRoot: string) => PlanPathsResult;
        checkFilePermission: (filePath: string, permissions: OxePermissionRule[], currentScope?: string) => {
            action: string;
            rule: OxePermissionRule | null;
        };
    ...
    plugins: {
        ...
        runHook: (plugins: OxePlugin[], hookName: string, ctx: Record<string, unknown>) => Promise<Array<{
            plugin: string;
            error: string;
        }>>;
        validatePlugins: (projectRoot: string) => PluginValidationResult;
        initPluginsDir: (projectRoot: string) => void;
        resolvePluginSources: (projectRoot: string, pluginsSources: Array<string | PluginSource>) => {
            resolved: string[];
            errors: Array<{
                source: string;
                error: string;
        ...
        installNpmPlugin: (projectRoot: string, pkgName: string, version?: string) => {
            ok: boolean;
            path: string;
            error: string;
        };
    ...
    dashboard: {
        loadDashboardContext: (projectRoot: string, opts?: {
            activeSession?: string | null;
    ...
    operational: {
        ...
        buildOperationalGraph: (runState?: Record<string, unknown>) => {
    ...
    azure: {
        ...
        searchAzureInventory: (projectRoot: string, query: string, filters?: {
            type?: string;
            resourceGroup?: string;
        }) => Array<Record<string, unknown>>;
        diffInventory: (previousItems: Array<Record<string, unknown>>, currentItems: Array<Record<string, unknown>>) => {
    ...
    artifacts: {
        ...
        renderLegend: () => string;
        classifyEntry: (oxeDir: string, entry: {
            path: string;
            kind: string;
        }) => 'absent' | 'empty' | 'active';
        buildMapModel: (target: string, opts?: {
            staleScan?: boolean;
        }) => {
            projectRoot: string;
            oxeExists: boolean;
        ...
        renderMap: (model: Record<string, unknown>, opts?: {
