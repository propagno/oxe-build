...
const finishTask = {
    ...
    schema: {
        ...
        function: {
            name: 'finish_task',
            description: 'Sinaliza que a tarefa foi totalmente concluída. Chame SOMENTE quando todas as ações requeridas estiverem feitas e verificadas.',
            parameters: {
                type: 'object',
                properties: {
                    summary: { type: 'string', description: 'Resumo do que foi realizado' },
                    evidence_paths: { type: 'array', items: { type: 'string' }, description: 'Caminhos de arquivos criados ou modificados como evidência' },
                },
                required: ['summary'],
            },
        },
